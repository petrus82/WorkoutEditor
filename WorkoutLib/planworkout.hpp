...
class PlanInterval : public Interval
{
public:
  explicit PlanInterval(std::fstream &file, WorkoutType intervalType, ValueRange value, Duration duration)
  ...
  {
    throw std::runtime_error("No heart rate target possible for .plan files.");
  }
