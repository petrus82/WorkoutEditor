...
class ErgInterval : public Interval
{
public:
    explicit ErgInterval(std::fstream &file, WorkoutType intervalType, ValueRange value, Duration duration)
    ...
    {
        throw std::runtime_error("Please provide absolute Watts for an ERG file.");
    }
